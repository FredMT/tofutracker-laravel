...
class ProcessAnimeMissingTags extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'anime:process-missing-tags';
     ...
     * @var string
     */
    protected $description = 'Continuously processes random AnidbAnime records missing tags until ban or completion.';

    private const ID_LIST_PATH = 'app/anime_ids_missing_tags.json';
    ...
    {
        $logger = Log::channel('anidbprocesstags');
        ...
        if (empty($ids)) {
            ...
            $ids = AnidbAnime::whereDoesntHave('tags')->pluck('id')->toArray();
        ...
        while (true) {
            ...
            $delayMicroseconds = rand(2000000, 2500000);
