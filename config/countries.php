    ...
    */
    'helpers' => [
        ...
        'getCountryCodes' => function () {
            return array_keys(config('countries.countries'));
        },
        ...
        'getCountryByCode' => function ($code) {
            return config('countries.countries.'.strtoupper($code));
        },
         ...
         * @return string|null
         */
        'getCountryEnglishName' => function ($code) {
            return config('countries.countries.'.strtoupper($code).'.english_name');
        },

        /**
         * Get country native name by code
         *
         * @param  string  $code
         * @return string|null
         */
        'getCountryNativeName' => function ($code) {
            return config('countries.countries.'.strtoupper($code).'.native_name');
        },
    ],
];
...
if (! function_exists('get_country_codes')) {
    ...
    {
        return config('countries.helpers.getCountryCodes')();
    }
}

if (! function_exists('get_country_by_code')) {
    function get_country_by_code($code)
    {
        return config('countries.helpers.getCountryByCode')($code);
    }
}
...
if (! function_exists('get_all_countries')) {
    ...
    {
        return config('countries.helpers.getAllCountries')();
    }
}

if (! function_exists('get_country_english_name')) {
    function get_country_english_name($code)
    {
        return config('countries.helpers.getCountryEnglishName')($code);
    }
}

if (! function_exists('get_country_native_name')) {
    function get_country_native_name($code)
    {
        return config('countries.helpers.getCountryNativeName')($code);
    }
}
