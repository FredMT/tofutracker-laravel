...
export const shadcnCssVariableResolver: CSSVariablesResolver = (theme) => ({
    ...
    light: {
        ...
        "--mantine-color-secondary-text":
            "var(--mantine-primary-color-contrast)", // can be used as secondary text color
        "--mantine-color-secondary-light-color":
            "var(--mantine-color-secondary-8)", // used as primary light variant's text color
    ...
    dark: {
        ...
        "--mantine-color-secondary-text":
            "var(--mantine-primary-color-contrast)", // can be used as secondary text color
        "--mantine-color-secondary-light-color":
            "var(--mantine-color-secondary-0)", // used as primary light text color
