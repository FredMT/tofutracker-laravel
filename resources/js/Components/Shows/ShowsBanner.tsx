...
const ShowsBanner = () => {
	const featuredShows = useShowsPageTrendingData().slice(0, 9);
				...
				{featuredShows.map((show) => (
					<Carousel.Slide key={show.id}>
						<div className='relative w-full h-full'>
							<Image
								src={`https://image.tmdb.org/t/p/original${show.backdrop}`}
								alt={show.title}
							...
							<div className='absolute bottom-0 left-0 right-0 px-8 md:px-16 py-20 flex flex-col md:flex-row items-end md:items-center justify-between'>
								<div className='w-full md:w-1/2 mb-8 md:mb-0'>
									...
									<motion.img
										...
										src={`https://image.tmdb.org/t/p/original${show.logo}`}
										alt={`${show.title} logo`}
