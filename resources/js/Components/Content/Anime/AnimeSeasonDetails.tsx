                    ...
                    >
                        <SimpleGrid cols={{ base: 1, sm: 2 }}>
                            ...
                            <Box>
                                ...
                                <Text>{data.rating_count.toLocaleString()}</Text>
                            </Box>
                    ...
                    >
                        ...
                        >
                            {data.external_links
                                .filter(
                                    (link) =>
                                        !["funimation", "thetvdb", "tmdb"].includes(link.type),
                                )
                                .filter((link, index, array) => {
                                    const imdbLinksSoFar = array
                                        .slice(0, index + 1)
                                        .filter((l) => l.type === "imdb").length;

                                    return link.type !== "imdb" || imdbLinksSoFar <= 1;
                                })
                                .map((link) => {
                                    const config = externalLinkMapping[link.type];
                                    return (
                                        <Group
                                        ...
                                        >
                                            ...
                                            <Text
                                                component="a"
                                                href={config.url(link.identifier)}
                                                target="_blank"
