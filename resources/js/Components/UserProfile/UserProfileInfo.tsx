	...
	return (
		...
		>
			...
			>
				...
				>
					<Button
						bg={`${component === 'UserProfile' ? 'violet.9' : '#222222'}`}
						bd={0}
						component={Link}
						href={`/user/${username}`}
					>
					...
					<Button
						bg={`${component === 'UserMovies' ? 'violet.9' : '#222222'}`}
						bd={0}
						component={Link}
					...
					<Button
						bg={`${component === 'UserTv' ? 'violet.9' : '#222222'}`}
						component={Link}
					...
					<Button
						bg={`${component === 'UserAnime' ? 'violet.9' : '#222222'}`}
						bd={0}
						component={Link}
					...
					<Button
						bg={`${component === 'UserCustomLists' ? 'violet.9' : '#222222'}`}
						bd={0}
						component={Link}
